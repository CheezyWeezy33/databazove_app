...
<body>
    <div class="container">
        ...
        execute_query($connection, $sql, "Prehľad pre všetky objednávky z roku 1996 a ich zákazníkov");
        ...
        $sql = "SELECT e.City, COUNT(DISTINCT e.EmployeeID) AS EmployeeCount, COUNT(DISTINCT c.CustomerID) AS CustomerCount
                ...
                GROUP BY e.City";
        execute_query($connection, $sql, "Počet zamestnancov a zákazníkov z každého mesta, ktoré má zamestnancov");
        ...
        $sql = "SELECT c.City, COUNT(DISTINCT e.EmployeeID) AS EmployeeCount, COUNT(DISTINCT c.CustomerID) AS CustomerCount
                ...
                GROUP BY c.City";
        execute_query($connection, $sql, "Počet zamestnancov a zákazníkov z každého mesta, ktoré má zákazníkov");
        ...
        $sql = "SELECT City, COUNT(DISTINCT EmployeeID) AS EmployeeCount, COUNT(DISTINCT CustomerID) AS CustomerCount
                ...
                GROUP BY City";
        execute_query($connection, $sql, "Počet zamestnancov a zákazníkov z každého mesta");
        ...
        $sql = "SELECT CustomerID, COUNT(*) AS TotalOrders
                ...
                GROUP BY CustomerID
                HAVING COUNT(*) > 15";
        execute_query($connection, $sql, "Celkový počet objednávok podľa zákazníka od 31. decembra 1994 (Objednávky > 15)");
