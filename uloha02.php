...
<body>
    ...
    <table border="1">
        ...
        if ($result_1996_orders->fetch_assoc() > 0) {
    ...
    <table border="1">
        ...
        if ($result_employees_customers_city -> fetch_assoc()> 0) {
    ...
    <table border="1">
        ...
        if ($result_customers_employees_city->fetch_assoc() > 0) {
    ...
    <table border="1">
        ...
        if ($result_employees_customers_all_cities -> fetch_assoc() > 0) {
    ...
    <table border="1">
        ...
        if ($result_late_orders -> fetch_assoc()> 0) {
    ...
    <table border="1">
        ...
        if ($result_low_quantity_products->fetch_assoc() > 0) {
    ...
    <table border="1">
        ...
        if ($result_orders_per_customer -> fetch_assoc() > 0) {
