...
<body>
    ...
    <table border="1">
        ...
        if ($result_employees_customers_city > 0) {
    ...
    <table border="1">
        ...
        if ($result_customers_employees_city > 0) {
    ...
    <table border="1">
        ...
        if ($result_employees_customers_all_cities > 0) {
    ...
    <table border="1">
        ...
        if ($result_orders_per_customer > 0) {
